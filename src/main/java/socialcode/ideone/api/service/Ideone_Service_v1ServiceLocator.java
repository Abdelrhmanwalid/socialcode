...
public class Ideone_Service_v1ServiceLocator extends
		org.apache.axis.client.Service implements
		socialcode.ideone.api.service.Ideone_Service_v1Service {
	...
	public Ideone_Service_v1ServiceLocator(java.lang.String wsdlLoc,
	...
	public socialcode.ideone.api.service.Ideone_Service_v1Port getIdeone_Service_v1Port(
		...
		try {
			socialcode.ideone.api.service.Ideone_Service_v1BindingStub _stub = new socialcode.ideone.api.service.Ideone_Service_v1BindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (socialcode.ideone.api.service.Ideone_Service_v1Port.class
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName(
					"http://ideone.com/api/1/service", "Ideone_Service_v1Port"));
		}
