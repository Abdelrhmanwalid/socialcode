...
;(function ($, window, document, undefined) {
    ...
    /** Default values */
    var pluginName = 'mediumInsert',
        addonName = 'CodeAddon', // first char is uppercase
        defaults = {
            label: '<span class="fa fa-code"></span>',
            placeholder: 'Paste the code link and press Enter',
            oembedProxy: 'code/embed',
            styles: {
                wide: {
                    label: '<span class="fa fa-align-justify"></span>',
                    // added: function ($el) {},
    ...
    CodeAddon.prototype.init = function () {
        this.events();
        this.backwardsCompatibility();
    };
    ...
    CodeAddon.prototype.events = function () {
        $(document)
            .on('click', $.proxy(this, 'unselectEmbed'))
            .on('keydown', $.proxy(this, 'removeEmbed'))
            .on('click', '.medium-insert-embeds-toolbar .medium-editor-action', $.proxy(this, 'toolbarAction'))
    ...
    CodeAddon.prototype.backwardsCompatibility = function () {
        var that = this;
     ...
     * @return {object} Core object
     */
    CodeAddon.prototype.getCore = function () {
        return this.core;
    };
    ...
    CodeAddon.prototype.add = function () {
        var $place = this.$el.find('.medium-insert-active');
    ...
    CodeAddon.prototype.disablePlaceholderSelection = function (e) {
        var $place = $(e.target).closest('.medium-insert-embeds-input');
    ...
    CodeAddon.prototype.togglePlaceholder = function (e) {
        var $place = $(e.target),
            selection = window.getSelection(),
            range, $current, $placeholder, re, text;
    ...
    CodeAddon.prototype.processLink = function (e) {
        var $place = this.$el.find('.medium-insert-embeds-active'),
            re, url;
    ...
    CodeAddon.prototype.oembed = function (url) {
        var that = this;
    ...
    CodeAddon.prototype.parseUrl = function (url) {
        var html;
    ...
    CodeAddon.prototype.embed = function (html) {
        var $place = this.$el.find('.medium-insert-embeds-active');
     ...
     * @return {void}
     */
    CodeAddon.prototype.convertBadEmbed = function (content) {
        var $place, $empty, $content,
            emptyTemplate = this.templates['src/js/templates/core-empty-line.hbs']().trim();
    ...
    CodeAddon.prototype.selectEmbed = function (e) {
        var $embed = $(e.target).hasClass('medium-insert-embeds') ? $(e.target) : $(e.target).closest('.medium-insert-embeds'),
            that = this;
    ...
    CodeAddon.prototype.unselectEmbed = function (e) {
        var $el = $(e.target).hasClass('medium-insert-embeds') ? $(e.target) : $(e.target).closest('.medium-insert-embeds'),
            $embed = this.$el.find('.medium-insert-embeds-selected');
    ...
    CodeAddon.prototype.removeEmbed = function (e) {
        var $embed, $empty;
    ...
    CodeAddon.prototype.addToolbar = function () {
        var $embed = this.$el.find('.medium-insert-embeds-selected'),
            active = false,
            $toolbar, $toolbar2, top;
    ...
    CodeAddon.prototype.toolbarAction = function (e) {
        var $button = $(e.target).is('button') ? $(e.target) : $(e.target).closest('button'),
            $li = $button.closest('li'),
            $ul = $li.closest('ul'),
            $lis = $ul.find('li'),
    ...
    CodeAddon.prototype.toolbar2Action = function (e) {
        var $button = $(e.target).is('button') ? $(e.target) : $(e.target).closest('button'),
            callback = this.options.actions[$button.data('action')].clicked;
    ...
    $.fn[pluginName + addonName] = function (options) {
        return this.each(function () {
            if (!$.data(this, 'plugin_' + pluginName + addonName)) {
                $.data(this, 'plugin_' + pluginName + addonName, new CodeAddon(this, options));
            }
        });
    };
